namespace FStore.Domain.Abstractions
{
    public interface IRepository<T> where T : class
    {
        ...
        T Get(Expression<Func<T, bool>> filter, string? includeProperties = null, bool tracked = false, Expression<Func<T, object>>? filterInclude = null);
        Task<T> GetAsync(Expression<Func<T, bool>> filter, string? includeProperties = null, bool tracked = false, Expression<Func<T, object>>? filterInclude = null);
